        ...
        return (
            <div>              
                <Fragment>
                    ...
                    {this.props.getAudioLikeTitle.loading ? (null) : ( (this.props.getAudioLikeTitle.audioLikeTitle && this.props.getAudioLikeTitle.audioLikeTitle.length >  0) ? (<Discover context={"playlist"} name={"Songs"} idList={this.props.getAudioLikeTitle.audioLikeTitle} elemSelected={this.elemSelected} />) : (<h3 className="discoverInfo">No song matches your query</h3>))}
                    {this.props.getAudioLikeArtist.loading ? (null) : ( (this.props.getAudioLikeArtist.audioLikeArtist && this.props.getAudioLikeArtist.audioLikeArtist.length >  0) ? (<Discover context={"playlist"} name={"Artists"} idList={this.props.getAudioLikeArtist.audioLikeArtist} elemSelected={this.elemSelected} />) : (<h3 className="discoverInfo">No artist matches your query</h3>))}
                </Fragment>
            </div>
        )
    }
