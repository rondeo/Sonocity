        ...
        return (
            <div>              
                <Fragment>
                    ...
                    {this.props.getAudioLikeTitle.loading ? (null) : ( (this.props.getAudioLikeTitle.audioLikeTitle && this.props.getAudioLikeTitle.audioLikeTitle.length >  0) ? (<Discover context={"playlist"} name={"\""+this.props.expression+"\""+" tracks"} idList={this.props.getAudioLikeTitle.audioLikeTitle} elemSelected={this.elemSelected} />) : (<h3 className="discoverInfo">No song matches your query</h3>))}
